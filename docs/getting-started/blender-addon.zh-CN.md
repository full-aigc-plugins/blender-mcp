...
> **预发布提醒**：`v0.4.0` 是正式版本。只从 [GitHub Release](https://github.com/full-aigc-plugins/blender-mcp/releases/latest) 下载，并在安装前核对 SHA-256。
...
- 已从 Release 下载 `partme-blender-mcp-addon-0.4.0.zip` 并校验 SHA-256。
