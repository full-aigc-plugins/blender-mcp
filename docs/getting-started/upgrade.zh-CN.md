...
> **发布提醒**：`v0.7.0-rc.2` 是候选版本。升级前必须从 [GitHub Release](https://github.com/full-aigc-plugins/blender-mcp/releases/tag/v0.7.0-rc.2) 下载并校验 SHA-256。
...
| 字段 | 含义 | 示例 |
|:---|:---|:---|
| `version` | Runtime 版本号 | `"0.7.0-rc.2"` |
