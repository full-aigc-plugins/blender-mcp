...
> **Pre-release notice**: `v0.5.2` is a release. Download only from [GitHub Release](https://github.com/full-aigc-plugins/blender-mcp/releases/latest) and verify SHA-256 before installing.
...
- `partme-blender-mcp-addon-0.5.2.zip` downloaded from Release and SHA-256 verified.
...
3. Select `partme-blender-mcp-addon-0.5.2.zip`. Do not extract it.
