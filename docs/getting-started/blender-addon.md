...
> **Release notice**: `v0.7.0-rc.2` is a release candidate. Download only from [GitHub Release](https://github.com/full-aigc-plugins/blender-mcp/releases/tag/v0.7.0-rc.2) and verify SHA-256 before installing.
...
- `partme-blender-mcp-addon-0.7.0-rc.2.zip` downloaded from Release and SHA-256 verified.
...
3. Select `partme-blender-mcp-addon-0.7.0-rc.2.zip`. Do not extract it.
