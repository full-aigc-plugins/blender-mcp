...
Download from [v0.5.1](https://github.com/full-aigc-plugins/blender-mcp/releases/tag/v0.5.1):
...
3. Select `partme-blender-mcp-addon-0.5.1.zip` without extracting it.
