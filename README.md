...
| Version | `0.7.0-rc.1` release candidate |
...
- Silent or unapproved use of Rodin, Hunyuan, Sketchfab, or other external services.
...
Download from [v0.7.0-rc.1](https://github.com/full-aigc-plugins/blender-mcp/releases/tag/v0.7.0-rc.1):

```text
partme-blender-mcp-addon-0.7.0-rc.1.zip
partme-blender-mcp-runtime-0.7.0-rc.1.zip
SHA256SUMS.txt
```
...
```bash
python -m pip install ./partme-blender-mcp-runtime-0.7.0-rc.1.zip
...
3. Select `partme-blender-mcp-addon-0.7.0-rc.1.zip` without extracting it.
...
`0.7.0-rc.1` is the current release candidate. The Harness keeps `codex-blender/v1` temporarily for differential migration from `codex-blender-plugin`; all public identity, MCP server ID, and Add-on surfaces use PartMe. Untested clients remain `DOCUMENTED_NOT_RUN`.
